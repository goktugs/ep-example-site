            ...
            <div className="flex w-full flex-1 justify-center  ">
                ...
                <div className="flex max-h-16 divide-x divide-slate-600 rounded-full bg-main-purple-dark px-5 py-5 shadow-main-input  ">
                    <div className="flex items-center justify-center font-bold text-white">
                        ...
                        <div className="w-36 max-w-full px-5 whitespace-nowrap  ">
                    ...
                    <div className="px-5 flex">
                        <input className="w-56 text-white placeholder:text-main-text-smoke text-sm bg-transparent font-semibold" type="text" placeholder="Kategori veya ürün arayın" name="" id="" />
                        <div className=" right-0 w-6 h-6" >
                            <SearchIcon />
                        </div>
                    </div>
                </div>
                <div className="flex gap-4 flex-1 justify-end" >
                    <div className="flex items-center gap-4 border rounded-full border-main-purple-light py-2 px-2" >
                        <div className="rounded-full flex items-center border border-main-purple" >
                            <div className="flex-1 flex flex-col text-right" >
                                <span className="text-sm font-bold text-lime-500" >10,00 ₺</span>
                                <span className="text-xs text-white whitespace-nowrap" >+ Bakiye Yükle</span>
                            </div>
                            <div>
                    ...
                    <div className="flex items-center gap-2 border rounded-full border-main-purple-light py-2 px-2" >
                        <div className="w-10 h-10 rounded-full flex justify-center items-center bg-main-purple-light text-white text-2xl">
                            <p>G</p>
                        </div>
                        <div className="flex flex-col" >
                            <span className="text-xs text-main-text-smoke font-semibold" >Merhaba</span>
                            <span className="text-xs text-white font-extrabold whitespace-nowrap" >Gökhan CAN</span>
                        </div>
                    </div>
                </div>
            </div>
